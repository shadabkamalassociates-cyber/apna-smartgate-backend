...
const { otpSenderForAdmin, passwordReset, otpSenderForResident, otpCheck, signUpOtpSender, SignUpUpOtpSenderForAdmin, guestLogin } = require('../controllers/common/Authentication');
