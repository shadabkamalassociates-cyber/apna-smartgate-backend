...
const { otpSenderForAdmin, passwordReset, otpSenderForResident, otpCheck, signUpOtpSender } = require('../controllers/common/Authentication');
...
authRouter.post('/signUp-otp-sender', signUpOtpSender);
